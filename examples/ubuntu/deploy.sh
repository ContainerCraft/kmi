...
#===============================================================================
# This script automates the deployment of Ubuntu 24.04 VirtualMachine with:
...
USERDATA_PATH="${SCRIPT_DIR}/ubuntu-24.04-userdata.yaml"
VM_MANIFEST_PATH="${SCRIPT_DIR}/ubuntu-24.04-vdi-xrdp-gnome-br0-containerdisk.yaml"
NAMESPACE="default"
SKIP_SECRETS=false
MONITOR=false
...
USERDATA_SECRET_NAME="ubuntu-24-04-userdata"
