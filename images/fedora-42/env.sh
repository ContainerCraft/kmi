...
# Removed tmp-files and machine-id - suspected of breaking DNS resolution
VIRT_SYSPREP_OPERATIONS=user-account,logfiles,customize,bash-history,yum-uuid,smolt-uuid,package-manager-cache
